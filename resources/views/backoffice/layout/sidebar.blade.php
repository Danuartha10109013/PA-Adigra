                ...
                @if (auth()->user()->role_id == 1)
                    ...
                    <li class="nav-item">
                        <a href="/backoffice/leave-quota"
                            class="nav-link {{ request()->is('backoffice/leave-quota', 'backoffice/leave-quota/*') ? 'active' : '' }}">
                    ...
                    <!-- <li class="nav-item has-treeview {{ request()->is('attendance/summary*') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ request()->is('attendance/summary*') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('attendance.summary.index') }}"
                                    class="nav-link {{ request()->is('attendance/summary') ? 'active' : '' }}">
                                    <i class="fa fa-circle fa-regular nav-icon"></i>
                                    <p>Data Rekapitulasi</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('attendance.summary.report') }}"
                                    class="nav-link {{ request()->is('attendance/summary/report') ? 'active' : '' }}">
                                    <i class="fa fa-circle fa-regular nav-icon"></i>
                                    <p>Laporan</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a href="{{route('attendance.summary.index')}}"
                            class="nav-link {{ request()->is('backoffice/attendance/summary','backoffice/attendance/summary/report') ? 'active' : '' }}
">
                            <!-- <i class="nav-icon fa fa-calendar-check"></i> -->
                            <i class="nav-icon fas fa-chart-bar"></i>
...
">
                ...
                <li class="nav-item">
                    <a href="/backoffice/meet"
                        class="nav-link {{ request()->is('backoffice/meet', 'backoffice/meet/*') ? 'active' : '' }}">
