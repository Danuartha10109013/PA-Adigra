                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <input type="text"  name="latitude" class="form-control mr-1 @if($errors->has('latitude')) is-invalid @endif" placeholder="Latitude" value="{{ old('latitude') }}"
                                    required oninvalid="this.setCustomValidity('Latitude harus diisi')" oninput="this.setCustomValidity('')">
                                    <input type="text"  name="longitude" class="form-control ml-1 @if($errors->has('longitude')) is-invalid @endif" placeholder="Longitude" value="{{ old('longitude') }}"
