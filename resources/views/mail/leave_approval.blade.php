...
<head>
    <meta charset="UTF-8">
    <title>Pengajuan Cuti Disetujui</title>
    <style>
...
<body>
    <div class="container">
        <h2>Pengajuan Cuti Anda Disetujui</h2>
        <div class="info">
            <table>
        ...
        <p>Pengajuan cuti Anda telah <b>disetujui</b> oleh admin. Silakan cek jadwal cuti Anda.</p>
        <div class="footer">
            Terima kasih,<br>
            {{ config('app.name') }}<br>
