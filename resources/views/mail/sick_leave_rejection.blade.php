...
<head>
    <meta charset="UTF-8">
    <title>Pengajuan Izin/Sakit Ditolak</title>
    <style>
...
<body>
    <div class="container">
        <h2>Pengajuan Izin/Sakit Anda Ditolak</h2>
        <div class="info">
            <table>
        ...
        <p>Mohon maaf, pengajuan izin/sakit Anda <b>ditolak</b> oleh admin. Silakan hubungi admin untuk informasi lebih lanjut atau ajukan ulang jika diperlukan.</p>
        <div class="footer">
            Terima kasih,<br>
            {{ config('app.name') }}<br>
